...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('phone_no', 'first_name', 'last_name', 'date_of_birth', 'email')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('phone_no', 'password', 'user_type', 'first_name', 'last_name', 'date_of_birth', 'county',
                  'locality', 'email', 'is_staff', 'is_active')
